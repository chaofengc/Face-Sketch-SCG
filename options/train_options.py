...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--vggface', type=str, default='', help='vgg face path')
        parser.add_argument('--cuhkface', type=str, default='', help='vgg face path')
        parser.add_argument('--cuhksketch', type=str, default='', help='vgg face path')
