...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--distributed', action='store_true', help='if specified, not use self-similarity feature')
        parser.add_argument('--local_rank', type=int, default=0, help='if specified, not use self-similarity feature')
        ...
        # model parameters
        parser.add_argument('--direction', type=str, default='AtoB', help='chooses which model to train [parse|enhance]')
        ...
        parser.add_argument('--n_layers_D', type=int, default=2, help='downsampling layers in discriminator')
        parser.add_argument('--D_num', type=int, default=3, help='numbers of discriminators')

        parser.add_argument('--Pnorm', type=str, default='gn', help='parsing net norm [in | bn| none]')
        parser.add_argument('--Gnorm', type=str, default='gn', help='generator norm [in | bn | none]')
        parser.add_argument('--Dnorm', type=str, default='none', help='discriminator norm [in | bn | none]')
        parser.add_argument('--act_type', type=str, default='leakyrelu', help='parsing net norm [in | bn| none]')
        parser.add_argument('--init_type', type=str, default='normal', help='network initialization [normal | xavier | kaiming | orthogonal]')
        parser.add_argument('--init_gain', type=float, default=0.02, help='scaling factor for normal, xavier and orthogonal.')
        # dataset parameters
        parser.add_argument('--dataset_name', type=str, default='CelebaMask', help='dataset name')
        ...
        parser.add_argument('--no_strict_load', action='store_true', help='if specified, print more debugging information')
